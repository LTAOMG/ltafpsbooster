...
fpsButton.Position = UDim2.new(0.5, -100, 0.05, 0)
...
paintingText.Position = UDim2.new(0.5, -100, 0.15, 0)
...
paintingText.TextColor3 = Color3.fromRGB(0, 0, 0)
...
local function increaseFPS()
    for _, obj in ipairs(game.Workspace:GetDescendants()) do
        if obj:IsA("BasePart") then
            ...
            paintingText.Text = "Painting Part: " .. obj.Name .. " Material Set"
        end
    end
